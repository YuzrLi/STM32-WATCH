...
\- Buzzer: active buzzer (PA3)

\- Status LEDs: green (PA8), yellow (PA9), red (PA10)
...
\- \*\*Added countdown timer\*\* — configurable duration, buzzer alarm, LED status indicators
...
9\. Countdown timer (1–99 min, buzzer alarm, green/yellow/red LED indicators)
